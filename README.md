...
| `/artist/{artist_id}/album/{id}/songs`             | GET    | ❌    | All songs of album              |
...
| `/playlist/{id}`                                   | GET    | ❌    | Single playlist                 |
...
| `/user/{user_id}/song/{song_id}/playlists`         | GET    | ✅    | Playlists containing song       |
| `/user/{user_id}/song/{song_id}/playlists`         | POST   | ✅    | Sync song playlists             |
